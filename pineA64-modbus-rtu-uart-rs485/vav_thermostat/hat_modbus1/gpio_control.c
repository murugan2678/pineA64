...
void init_gpio()
{
  ...
  // struct gpiod_line *gpiod_chip_get_line(struct gpiod_chip *chip, unsigned i        nt offset)
  ...
  //  int gpiod_line_request_output(struct gpiod_line *line, const char *consum    e    r, int default_val)
